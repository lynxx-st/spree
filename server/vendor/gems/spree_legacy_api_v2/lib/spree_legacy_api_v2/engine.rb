...
module SpreeLegacyApiV2
  class Engine < Rails::Engine
    ...
    initializer 'spree.legacy_api_v2.checking_migrations' do
      ...
      # Rails 8 no longer exposes Rails::Engine::Migrations.
      checker = defined?(::Rails::Engine::Migrations) ? ::Rails::Engine::Migrations : nil
      checker&.new(config, engine_name)&.check
    end
